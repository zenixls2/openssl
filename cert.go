...
// Specify constants for x509 versions because the standard states that
// they are represented internally as the common version name.
const (
	X509_V1 = 0
	X509_V3 = 2
)
...
// SetVersion assings a certificate standard version to the CertificateInfo
// It is recommended to use the constants X509_V1 and X509_V3, as the
